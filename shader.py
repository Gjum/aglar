...
class Shader:
    ...
    def createShader(self, strings, type):
        ...
        src = (c_char_p * count)(*(s.encode('ascii') for s in strings))
        ...
        if not temp:
            ...
            print('Shader compiling failed:', *buffer.value.decode().split('\n'), sep='\n')
        else:
    ...
    def link(self):
        ...
        if not temp:
            ...
            # print the log to the console
            print('Shader linking failed:', *buffer.value.decode().split('\n'), sep='\n')
        else:
    ...
    def uniformf(self, name, *vals):
        ...
        if len(vals) in range(1, 5):
            ...
            {1: glUniform1f,
             ...
             3: glUniform3f,
             4: glUniform4f,
            # retrieve and set the uniform location
